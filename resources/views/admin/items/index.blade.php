        ...
        <div class="col-12 col-lg-4">
            <div class="wisiva-counter-card bg-c-3">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Videos') }}</p>
                    <p class="wisiva-counter-card-number">{{ number_format($counters['videos']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-4">
            <div class="wisiva-counter-card bg-c-4">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Audios') }}</p>
                    <p class="wisiva-counter-card-number">{{ number_format($counters['audios']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-4">
            <div class="wisiva-counter-card bg-secondary">
                <div class="wisiva-counter-card-bg"></div>
                <div class="wisiva-counter-card-icon">
                    <i class="fa-solid fa-box"></i>
                </div>
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Others') }}</p>
                    <p class="wisiva-counter-card-number">{{ number_format($counters['others']) }}</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="wisiva-item-box">
                                                <a class="wisiva-item-image"
                                        ...
                                        <td class="text-start">
                                            ...
                                            @else
                                                <div class="table-price mb-3">
                                                    <div
                                                        class="row row-cols-auto align-items-center justify-content-center flex-nowrap">
                                                        <!--div class="col">
                                                            <h6 class="mb-0 text-dark">
                                                                {{ translate('Regular') }}
                                                            </h6>
                                                        ...
                                                        <div class="col ">
                                                            <div class="item-price d-flex flex-column align-items-center">
                                                                @if ($item->isOnDiscount())
                                                                    <span class="item-price-through text-muted fs-6">
                                                                        {{ getAmount($item->getRegularPrice(), 0, '.', '') }}
                                                                    </span> 
                                                                    <span class="item-price-number text-success fs-5 fw-bold"> 
