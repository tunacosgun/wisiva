...
@section('content')
    <form id="wisiva-submited-form" action="{{ route('admin.settings.captcha-providers.update', $captchaProvider->id) }}"
        method="POST">
        @csrf
        <div class="card mb-4">
            <div class="card-body">
                <div class="wisiva-file-preview-box bg-light mb-3 p-4 text-center">
