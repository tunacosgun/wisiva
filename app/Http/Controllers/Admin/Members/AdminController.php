...
class AdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'username' => ['required', 'string', 'min:3', 'max:50', 'alpha_dash', 'block_patterns', 'unique:users'],
    ...
    public function update(Request $request, User $admin)
    {
        $validator = Validator::make($request->all(), [
            'firstname' => ['required', 'string', 'block_patterns', 'max:50'],
            'lastname' => ['required', 'string', 'block_patterns', 'max:50'],
            'username' => ['required', 'string', 'min:3', 'max:50', 'alpha_dash', 'block_patterns', 'unique:users,username,' . $admin->id],
