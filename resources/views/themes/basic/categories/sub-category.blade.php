...
@section('content')
    ...
    <div class="row g-2 align-items-center mb-4">
        ...
        <div class="col-auto">
            <button class="btn btn-theme btn-padding d-block d-lg-none" type="button" data-bs-toggle="offcanvas"
                data-bs-target="#searchFillters" aria-controls="searchFillters">
