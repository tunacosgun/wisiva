...
@section('content')
    <form id="wisiva-submited-form" action="{{ route('admin.financial.payment-gateways.update', $paymentGateway->id) }}"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-4">
                        <div class="wisiva-file-preview-box mb-3 bg-light p-4 text-center">
