        ...
        <div class="col-12 col-lg-6">
            <div class="wisiva-counter-card bg-green">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Total Cedited') }}
                        ({{ numberFormat($counters['credit']['total']) }})</p>
                    <p class="wisiva-counter-card-number">{{ getAmount($counters['credit']['amount']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6">
            <div class="wisiva-counter-card bg-danger">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Total Debited') }}
                        ({{ numberFormat($counters['debit']['total']) }})</p>
                    <p class="wisiva-counter-card-number">{{ getAmount($counters['debit']['amount']) }}</p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                @foreach ($statements as $statement)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <strong>{{ $statement->getAmount() }}</strong>
                                        </td>
