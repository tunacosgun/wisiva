        ...
        <div class="col-12 col-lg-6 col-xxl-6">
            <div class="wisiva-counter-card bg-green">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Opened tickets') }}</p>
                    <p class="wisiva-counter-card-number">{{ $counters['opened_tickets'] }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl-6">
            <div class="wisiva-counter-card bg-red">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Closed tickets') }}</p>
                    <p class="wisiva-counter-card-number">{{ $counters['closed_tickets'] }}</p>
                </div>
            </div>
        </div>
    </div>
