...
class PackagesController extends Controller
{
    public function index()
    {
        ...
        $homePackages = Packages::where('home', 1)->get(); // Fetch packages with home = 1

        return view('admin.packages.index', [
            'packages' => $packages,
            'homePackages' => $homePackages, // Pass home packages to the view
        ]);
    }
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'show_on_homepage' => ['nullable', 'boolean'], // Added validation for show_on_homepage
        ]);
        ...
        $package->home = $request->has('show_on_homepage') ? 1 : 0; // Set home column
        $package->save();
