...
@section('content')
    <div class="row g-3 mb-4">
        <div class="col-12 col-lg-6 col-xxl">
            <div class="wisiva-counter-card bg-orange">
                <div class="wisiva-counter-card-bg"></div>
                <div class="wisiva-counter-card-icon">
                    <i class="fa-regular fa-hourglass-half"></i>
                </div>
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Pending') }}</p>
                    <p class="wisiva-counter-card-number">{{ $counters['pending'] }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl">
            <div class="wisiva-counter-card bg-success">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Approved') }}</p>
                    <p class="wisiva-counter-card-number">{{ $counters['approved'] }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl">
            <div class="wisiva-counter-card bg-danger">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Rejected') }}</p>
                    <p class="wisiva-counter-card-number">{{ $counters['rejected'] }}</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <table class="wisiva-normal-table table w-100">
                        ...
                        <tbody>
                            @foreach ($kycVerifications as $kycVerification)
                                <tr>
                                    <td>
                                        <a href="{{ route('admin.kyc.kyc-verifications.review', $kycVerification->id) }}">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-sm-end"
                                                ...
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.kyc.kyc-verifications.review', $kycVerification->id) }}"><i
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('admin.kyc.kyc-verifications.destroy', $kycVerification->id) }}"
                                                        method="POST">
                                                        @csrf @method('DELETE')
