...
@section('content')
    <form id="wisiva-submited-form" action="{{ route('admin.sections.home-categories.update', $homeCategory->id) }}"
        ...
        <div class="card p-2 pb-3">
            <div class="card-body">
                <div class="row g-3 row-cols-1">
                    <div class="col">
                        <div class="wisiva-file-preview-box bg-light p-4 text-center">
