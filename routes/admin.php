...
use App\Http\Controllers\Admin\OfferSubmissionsController;

Route::middleware(['auth', 'admin'])->group(function () {
    Route::prefix('themedit')->group(function () {
        Route::get('/', [ThemeEditorController::class, 'index'])->name('admin.themedit.index');
        Route::get('/edit/{file}', [ThemeEditorController::class, 'edit'])->name('admin.themedit.edit');
        Route::post('/update/{file}', [ThemeEditorController::class, 'update'])->name('admin.themedit.update');
    });
});
...
Route::name('admin.')->middleware('maintenance')->group(function () {
    ...
    Route::middleware(['auth', 'admin', '2fa.verify'])->group(function () {
        ...
        Route::name('packages.')->prefix('packages')->group(function () {
            ...
            Route::get('{package}', [PackagesController::class, 'show'])->name('show');
            ...
            Route::post('/generate-slug', [PackagesController::class, 'generateSlug'])->name('generate-slug');
        });

        Route::name('offers.')->prefix('forms')->group(function () { 
            ...
            Route::post('/generate-slug', [OffersController::class, 'generateSlug'])->name('generate-slug');
        });

        Route::name('offer_submissions.')->prefix('form-submissions')->group(function () {
            Route::get('/', [OfferSubmissionsController::class, 'index'])->name('index'); 
            Route::get('/{id}', [OfferSubmissionsController::class, 'show'])->name('show');
        });
