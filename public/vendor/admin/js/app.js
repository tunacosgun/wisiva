(function($) {
    ...
    if (dropdown !== null) {
        dropdown.forEach((el) => {
            let dropdownFunc = () => {
                let sideBarLinksMenu = el.querySelector('.wisiva-sidebar-link-menu');
            ...
            el.querySelector('.wisiva-sidebar-link-title').onclick = () => {
    ...
    let sideBar = document.querySelector('.wisiva-sidebar'),
        pageContent = document.querySelector('.wisiva-page-content'),
        sideBarIcon = document.querySelector('.wisiva-sibebar-icon');
    if (sideBar !== null) {
        sideBarIcon.onclick = () => {
    ...
    let sidebarLinkCounter = document.querySelectorAll(".wisiva-sidebar-link-title .counter");
    ...
    let navbarLinkCounter = document.querySelectorAll(".wisiva-notifications-title .counter");
    ...
    let commentView = $('.wisiva-view-comment'),
