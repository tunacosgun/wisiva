...
<body class="bg-white {{ @$settings->announcement->status && !request()->hasCookie('announce_close') ? 'pt-0' : '' }}">
            ...
            <div class="section-inner">
                <div class="section-body">
                    <div class="row g-3">
                        ...
                        <div class="left-icon"><i class="fa fa-question" aria-hidden="true"></i></div>
                        <div class="icon-text">
                            BAYİLİK AVANTAJI                        </div>
                        Hemen bayilik başlatarak bir çok ürünü <strong>%35’e</strong> varan indirimlerle satın alabilir ya da kiralayabilirsiniz.                                        <a href="/iletisim" style="font-weight: 600; " target="_blank">Detaylar</a>                    </div>
                                        </div>
                                    </div>
                                    <div class="box-body p-4">
                                        <form data-action="{{ route('cart.add-item') }}" class="add-to-cart-form"
                                            ...
                                            <div class="form-check form-check-lg mb-3">
                                                ...
                                                <label class="form-check-label d-flex justify-content-between"
                                                    ...
                                                    <div>
                                                        <h6 class="mb-1">{{ translate('Satın Alma Fiyatı') }}</h6>
                                                        <small
                                                            class="small text-muted">{{ translate('Fiyatlara KDV Dahildir.') }}</small>
                                                    </div>
  ...
  <h2>Yazılımınız için Yeni Nesil Çözümler</h2>
  <p>İşinizi büyütmek ve dijital dönüşümde bir adım önde olmak için hemen harekete geçin!</p>
</div>
                                </div>
                            </div>
                            <div class="box bg-color p-4 mt-4">
