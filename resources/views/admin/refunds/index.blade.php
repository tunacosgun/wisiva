    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="wisiva-counter-card bg-orange">
                ...
                <div class="wisiva-counter-card-meta">
                    ...
                    <p class="wisiva-counter-card-number">{{ numberFormat($counters['pending']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-6 col-xxl-4">
            <div class="wisiva-counter-card bg-green">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Accepted') }}</p>
                    <p class="wisiva-counter-card-number">{{ numberFormat($counters['accepted']) }}</p>
                </div>
            </div>
        </div>
        <div class="col-12 col-lg-12 col-xxl-4">
            <div class="wisiva-counter-card bg-red">
                ...
                <div class="wisiva-counter-card-meta">
                    <p class="wisiva-counter-card-title">{{ translate('Declined') }}</p>
                    <p class="wisiva-counter-card-number">{{ numberFormat($counters['declined']) }}</p>
                </div>
            </div>
        </div>
    </div>
