...
Route::get('/entegrasyon-cozumleri', [ExtraController::class, 'integration']);
Route::get('/eticaret-cozumleri', [ExtraController::class, 'ecommerce']);
Route::get('/seo-hizmetleri', [ExtraController::class, 'seo']);
Route::get('/web-tasarim-hizmetleri', [ExtraController::class, 'webdesign']);
...
Route::middleware(['oauth.complete', 'verified', '2fa.verify'])->group(function () {
    ...
    Route::middleware('maintenance')->group(function () {
        ...
        Route::name('categories.')->prefix('kategori')->group(function () {
        ...
        Route::name('items.')->prefix('yazilim')->group(function () {
            ...
            Route::middleware('item.views')->group(function () {
                ...
                Route::post('{slug}/{id}/buy-now', 'ItemController@buyNow')->name('buy-now')->middleware(['auth', 'user', 'buy_now.disable']);
        ...
        Route::get('paket/{slug}', 'GeneralController@packages')->name('packages'); 
        
        Route::get('form/{slug}', 'GeneralController@offer')->name('offer');
        Route::post('form/{slug}', 'GeneralController@submitOffer')->name('submit.offer');
    });
});